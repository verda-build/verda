...
export type ActionKitFunction = (ce: ActionEnv, config: VerdaConfig) => ActionKit;
export type ActionEnvKit = { [key: string]: (argument: any) => ActionEnv };
export type ActionEnvKitFunction = (ce: ActionEnv, config: VerdaConfig) => ActionEnvKit;

// Default command bindings
export function defaultActionKit(ce: ActionEnv, config: VerdaConfig) {
	return {
...
export function defaultActionEnvKit(ce: ActionEnv, config: VerdaConfig) {
